...
var Unstake = (_dec = (0, _typeorm.Entity)(), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)("uuid"), _dec3 = (0, _typeorm.Column)("varchar"), _dec4 = (0, _typeorm.Column)("varchar"), _dec5 = (0, _typeorm.Column)("varchar"), _dec6 = (0, _typeorm.Column)("varchar"), _dec7 = (0, _typeorm.Column)("varchar", {
  nullable: true
}), _dec8 = (0, _typeorm.Column)("varchar"), _dec9 = (0, _typeorm.Column)("varchar"), _dec10 = (0, _typeorm.Column)("varchar"), _dec11 = (0, _typeorm.Column)("numeric"), _dec(_class = (_class2 = function Unstake() {
  (0, _classCallCheck2["default"])(this, Unstake);
  ...
  (0, _initializerDefineProperty2["default"])(this, "unStakedTokenAddress", _descriptor4, this);
  (0, _initializerDefineProperty2["default"])(this, "unStakedAmount", _descriptor5, this);
  (0, _initializerDefineProperty2["default"])(this, "stakeId", _descriptor6, this);
  ...
  writable: true,
  initializer: null
}), _descriptor4 = (0, _applyDecoratedDescriptor2["default"])(_class2.prototype, "unStakedTokenAddress", [_dec5], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor5 = (0, _applyDecoratedDescriptor2["default"])(_class2.prototype, "unStakedAmount", [_dec6], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor6 = (0, _applyDecoratedDescriptor2["default"])(_class2.prototype, "stakeId", [_dec7], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
